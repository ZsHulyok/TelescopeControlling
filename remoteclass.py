...
CONST_MOTOR1_LEPES_PORT = 16
CONST_MOTOR1_FORGATAS_PORT = 20
CONST_MOTOR1_LEPES_FELBONTAS_M0 = 23
CONST_MOTOR1_LEPES_FELBONTAS_M1 = 24

CONST_MOTOR2_LEPES_PORT = 13
CONST_MOTOR2_LEPES_FELBONTAS_M0 =26
CONST_MOTOR2_LEPES_FELBONTAS_M1 = 19
CONST_MOTOR2_FORGATAS_PORT = 6

"""GPIO.setwarnings(False)
GPIO.setmode(GPIO.BCM)"""

"""GPIO.setup(CONST_MOTOR1_FORGATAS_PORT, GPIO.OUT)
GPIO.setup(CONST_MOTOR1_LEPES_PORT, GPIO.OUT)
GPIO.setup(CONST_MOTOR1_LEPES_FELBONTAS_M0, GPIO.OUT)
GPIO.setup(CONST_MOTOR1_LEPES_FELBONTAS_M1, GPIO.OUT)
# _________Motor2-höz tartozó Gpio portok
GPIO.setup(CONST_MOTOR2_FORGATAS_PORT, GPIO.OUT)
GPIO.setup(CONST_MOTOR2_LEPES_PORT, GPIO.OUT)
GPIO.setup(CONST_MOTOR2_LEPES_FELBONTAS_M0, GPIO.OUT)
GPIO.setup(CONST_MOTOR2_LEPES_FELBONTAS_M1, GPIO.OUT)"""
...
class MenuBar(tkinter.Menu):
    def __init__(self, parent):
        ...
        self.leptetoMotor1 = MotorControlModel(CONST_MOTOR1_LEPES_PORT, CONST_MOTOR1_FORGATAS_PORT,
                                               CONST_MOTOR1_LEPES_FELBONTAS_M0, CONST_MOTOR1_LEPES_FELBONTAS_M1)
        self.leptetoMotor2 = MotorControlModel(CONST_MOTOR2_LEPES_PORT, CONST_MOTOR2_FORGATAS_PORT,
                                               CONST_MOTOR2_LEPES_FELBONTAS_M0, CONST_MOTOR2_LEPES_FELBONTAS_M1)
    ...
    def Beállítások(self):
        ...
        self.Fél_lépés_Motor1 = Radiobutton(Beállítás_ablak, text="Fél", variable=self.leptetoMotor1.motorMode, value="Fel", command=self.leptetoMotor1.SetFelMotorMode)
        self.Fél_lépés_Motor1.grid(row=1, sticky=W, padx=30)
        self.Egész_lépés_Motor1 = Radiobutton(Beállítás_ablak, text="Egész", variable=self.leptetoMotor1.motorMode, value="Teljes", command=self.leptetoMotor1.SetTeljesMotorMode)
        self.Egész_lépés_Motor1.grid(row=2, sticky=W, padx=30)
        self.Nyolcad_lépés_Motor1 = Radiobutton(Beállítás_ablak, text="Nyolcad", variable=self.leptetoMotor1.motorMode, value="Nyolcad",
                                                command=self.leptetoMotor1.SetNyolcadMotorMode)
        self.Nyolcad_lépés_Motor1.grid(row=3, sticky=W, padx=30)
        self.Tizenhatod_lépés_Motor1 = Radiobutton(Beállítás_ablak, text="Tizenhatod", variable=self.leptetoMotor1.motorMode, value="Tizenhatod", command=self.leptetoMotor1.SetTizenhatodMotorMode)
        ...
        self.Motor1_sebesség = Scale(Beállítás_ablak, from_=1, to=100, orient=HORIZONTAL , command=lambda value: self.leptetoMotor1.SetSpeed(value))
        self.leptetoMotor1.sebesseg_Arany = self.Motor1_sebesség.get()
        ...
        self.Fél_lépés_Motor2 = Radiobutton(Beállítás_ablak, text="Fél", variable=self.leptetoMotor2.motorMode, value="Fel", command=self.leptetoMotor2.SetFelMotorMode)
        self.Fél_lépés_Motor2.grid(row=1, column=1, sticky=W, padx=80)
        self.Egész_lépés_Motor2 = Radiobutton(Beállítás_ablak, text="Egész", variable=self.leptetoMotor2.motorMode, value="Teljes", command=self.leptetoMotor2.SetTeljesMotorMode)
        self.Egész_lépés_Motor2.grid(row=2, column=1, sticky=W, padx=80)
        self.Nyolcad_lépés_Motor2 = Radiobutton(Beállítás_ablak, text="Nyolcad", variable=self.leptetoMotor2.motorMode, value="Nyolcad",
                                                command=self.leptetoMotor2.SetNyolcadMotorMode)
        self.Nyolcad_lépés_Motor2.grid(row=3, column=1, sticky=W, padx=80)
        self.Tizenhatod_lépés_Motor2 = Radiobutton(Beállítás_ablak, text="Tizenhatod", variable=self.leptetoMotor2.motorMode, value="Tizenhatod",
                                                   command=self.leptetoMotor2.SetTizenhatodMotorMode)
        ...
        self.Motor2_sebesség = Scale(Beállítás_ablak, from_=1, to=100, orient=HORIZONTAL, command=lambda value: self.leptetoMotor2.SetSpeed(value))
        self.leptetoMotor2.sebesseg_Arany = self.Motor2_sebesség.get()
...
class Ablak(tkinter.Tk):
    ...
    def Le(self):
        ...
        self.menubar.leptetoMotor1.MakeStep(0)  # ...0 = forgásirány óramutató járásával megeggyező
        pass
    ...
    def Fel(self):
        ...
        self.menubar.leptetoMotor1.MakeStep(1)  # ...1 = forgásirány óramutató járásával ellenkező

        pass

    def Bal(self):
        global forgás
        forgás = self.after(0, self.Bal)
        self.menubar.leptetoMotor2.MakeStep(0)
    ...
    def Jobb(self):
        global forgás
        forgás = self.after(0, self.Jobb)
        self.menubar.leptetoMotor2.MakeStep(1)
